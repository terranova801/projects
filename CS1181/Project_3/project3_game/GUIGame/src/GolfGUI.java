...
public class GolfGUI {
    public static void main(String[] args) throws Exception {
        ...
        tableCenter.setBackground(new Color(53, 101, 77));
        playerPanel.setBackground(new Color(53, 101, 77));
        npcOnePanel.setBackground(new Color(53, 101, 77));
        npcTwoPanel.setBackground(new Color(53, 101, 77));
        npcThreePanel.setBackground(new Color(53, 101, 77));
